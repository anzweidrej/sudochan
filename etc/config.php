...
$config['filters'][] = [
    'condition' => [
        'flood-match' => ['ip'], // Only match IP address
...
$config['filters'][] = [
    'condition' => [
        'flood-match' => ['body'], // Match only post body
...
// The format string passed to gmdate() for displaying dates.
...
// Replace ?/config with a simple text editor for editing instance-config.php.
