        ...
        if (this.checked) {
            var post_form = $(
                '<form class="post-actions" method="post" style="margin:10px 0 0 0">' +
                    ...
                    '<input id="password_' +
                    id +
                    '" type="password" name="password" size="11" maxlength="18">' +
                    '<input title="' +
                    _('Delete file only') +
                    '" type="checkbox" name="file" id="delete_file_' +
                    id +
                    '">' +
                    '<label for="delete_file_' +
                    id +
                    '">' +
                    _('File') +
                    '</label>' +
                    ...
                    '<input id="reason_' +
                    id +
                    '" type="text" name="reason" size="20" maxlength="100">' +
            ...
            if (elm.attr('class') == 'post-actions') elm.remove();
        }
    };
