...
onready(function () {
    var inline_expand_post = function () {
        ...
        for (var i = 0; i < link.length; i++) {
            if (
                typeof link[i] == 'object' &&
                link[i].childNodes &&
                typeof link[i].childNodes[0] !== 'undefined' &&
                link[i].childNodes[0].src &&
                link[i].childNodes[0].className.match(/post-image/) &&
                !link[i].className.match(/file/)
            ) {
