        ...
        $form.on('submit', function () {
            ...
            var updateProgress = function (e) {
                ...
                $(form)
                    ...
                    .val(_('Posting... (#%)').replace('#', percentage));
            };
            ...
            $.ajax(
                {
                    ...
                    success: function (post_response) {
                        if (post_response.error) {
                            ...
                            if (
                                !$(form).find('input[name="thread"]').length ||
                                (!settings.get('always_noko_replies', true) &&
                                    !post_response.noko)
                            ) {
                                ...
                                $.ajax(
                                    {
                                        ...
                                        success: function (data) {
                                            ...
                                            $(form)
                                                .find(
                                                    'input[name="subject"],input[name="file_url"],\
										            textarea[name="body"],input[type="file"]',
                                                )
                                                .val('')
                                                .change();
                                        },
