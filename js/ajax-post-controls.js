...
$(window).ready(function () {
    ...
    var setup_form = function ($form) {
        ...
        $form.on('submit', function (e) {
            if (!$(this).data('submit-btn')) return true;
            ...
            formData.append(
                $($(form).data('submit-btn')).attr('name'),
                $($(form).data('submit-btn')).val(),
            );
                        ...
                        if (post_response.error) {
                            ...
                            if (
                                ...
                                if ($(form).hasClass('post-actions')) {
                                    $(form)
                                        .parents('div.post')
                                        .find('input[type="checkbox"].delete')
                                        .trigger('click');
                                } else {
                                    $(form)
                            ...
                            alert(_('An unknown error occurred!'));
                        }
                        $($(form).data('submit-btn'))
                            .val($($(form).data('submit-btn')).data('orig-val'))
                            .removeAttr('disabled');
                    },
            ...
            $($(form).data('submit-btn'))
                .attr('disabled', true)
                .data('orig-val', $($(form).data('submit-btn')).val())
                .val(_('Working...'));
